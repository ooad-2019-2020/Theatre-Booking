...
namespace TheaterBooking.Controllers
{
    public class RezervacijaController : Controller
    {
        ...
        {
            var biloStaContext = _context.Rezervacija.Include(r => r.Predstava);
        ...
        [Authorize(Roles = " Kupac, PremiumKupac")]
        public IActionResult Create()
        {
            ViewData["PredstavaID"] = new SelectList(_context.Predstava, "PredstavaID", "Termin");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PredstavaID")] Rezervacija rezervacija)
        {
